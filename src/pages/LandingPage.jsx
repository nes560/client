...
const LandingPage = () => {
  ...
  return (
    <>
      {/* ✅ 2. Tambahkan Meta Tags SEO Disini */}
      <Helmet>
        <title>HandyMan - Jasa Tukang Listrik, AC & Renovasi Terpercaya</title>
        <meta name="description" content="Pesan jasa tukang profesional untuk servis AC, perbaikan listrik, dan renovasi rumah dengan cepat dan aman di HandyMan App." />
        <meta name="keywords" content="jasa tukang, servis ac, tukang listrik, renovasi rumah, aplikasi tukang" />
      </Helmet>
